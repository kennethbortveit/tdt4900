...
The findings suggests that learning through social interactions are key to successfully introduce ICT's in developing countries. Large scale solutions in order to facilitate sustainability and a focus on educational systems as well as and technological infrastructure to achieve higher success rates.
\end{abstract}